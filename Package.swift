...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GemstoneFFI",
            url: "https://github.com/weaver-max/gemstone-swift/releases/download/2.114.10/GemstoneFFI.xcframework.zip",
            checksum: "de4a8463ce41036c2580ca8710382178965ddfc7e907f93d78000f15e11c44e6"
        ),
    ]
)
